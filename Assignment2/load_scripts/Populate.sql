...
SELECT 
		...
		"Staff office" AS Location_ID,
		"Office Location" AS Location_Name,
...
SELECT DISTINCT Staff_ID, Staff_First_Name, Staff_Surname, Location_ID, Location_Name
...
(Dim_Date_ID, Dim_Customer_ID, Dim_Staff_ID, Dim_Item_ID, Receipt_ID, Receipt_Transaction_Row_ID, Location_ID, Item_Quantity, Row_Total)
